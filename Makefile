.PHONY: all test test-modern unit-test integration-test functional-test coverage clean fclean re help start-daemon stop-daemon restart-daemon status-daemon docker-build docker-run docker-stop docker-logs
...
help:
	...
	@echo "  functional-test  - Run only functional tests"
